...
function modernize(legacy) {
  ...
  if (legacy.hasOwnProperty('credentials')) {
    ...
    if (legacy.secure.hasOwnProperty('caPath')) {
      modernized.credentials.caPath = legacy.secure.caPath;
    }
    if (legacy.secure.hasOwnProperty('SNICallback')) {
      modernized.credentials.SNICallback = legacy.secure.SNICallback;
    }
  ...
  if (legacy.hasOwnProperty('interfaces')) {
    ...
    if (mqtts_enabled) {
      ...
      if (legacy.secure.hasOwnProperty('requestCert')) {
        mqtts_interface.requestCert = legacy.secure.requestCert;
      }
      if (legacy.secure.hasOwnProperty('rejectUnauthorized')) {
        mqtts_interface.rejectUnauthorized = legacy.secure.rejectUnauthorized;
      }
...
function validate(opts, validationOptions) {
  ...
  validator.addSchema({
    ...
    properties: {
      ...
      'caPath': { type: 'string', required: true },
      'SNICallback': { type: 'function' },
    }
  });
